...
<div class="login-form">
    <form runat="server">
        ...
        <div class="form-group">
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="LoginEmailTxt" CssClass="alert-danger" ErrorMessage="RequiredFieldValidator" InitialValue="null">Please enter an Email Address</asp:RequiredFieldValidator>
        </div>
        <div class="form-group">
             <asp:TextBox ID="LoginPasswordTxt" runat="server" CssClass="form-control" placeholder="Password"></asp:TextBox>
             <asp:Label ID="Label2" runat="server" CssClass="alert-danger" Visible="False"></asp:Label>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="LoginPasswordTxt" CssClass="alert-danger" ErrorMessage="RequiredFieldValidator" InitialValue="null">Please Enter A Password</asp:RequiredFieldValidator>
        </div>
        <div class="form-group">
